<?php
	...
	{
        // create socket
        $socketCapteur = socket_create(AF_INET, SOCK_STREAM, 0) or die("Could not create socket\n");
        // connect to server
        $resultCapteur = socket_connect($socketCapteur, HOST, PORT_CAPTEUR) or die("Could not connect to server\n");
        // send string to server
        
        $resultCapteur = socket_read ($socketCapteur, 2048) or die("Could not read server response\n");
        echo $resultCapteur;
